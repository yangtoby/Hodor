...
namespace NFine.WebT.Controllers
{
    ...
    public class ClientsDataController : Controller
    {
        ...
        private object GetUserList()
        {
            ...
            var userData = new UserApp().GetList();
            Dictionary<string, string> dictionaryUser = new Dictionary<string, string>();
            foreach (var item in userData)
            {
                dictionaryUser.Add(item.F_Id, item.F_RealName);
            }
        ...
        {
            var areaData = new AreaApp().GetList();
            Dictionary<string, string> dictionaryArea = new Dictionary<string, string>();
            foreach (var item in areaData)
            {
                dictionaryArea.Add(item.F_Id, item.F_FullName);
            }
        ...
        private object GetDataItemList()
        {
            ...
            foreach (var item in new ItemsApp().GetList())
            {
                ...
                {
                    dictionaryItemList.Add(itemList.F_Id, itemList.F_ItemName);
                }
